...
public class frmUtama extends javax.swing.JFrame {
    ...
    private void autonomer(){
        Valid.autoNomer3("select ifnull(MAX(CONVERT(antriloketcetak.nomor,signed)),0) from antriloketcetak where antriloketcetak.tanggal=current_date()","",1,LabelNomor);
    }
}
