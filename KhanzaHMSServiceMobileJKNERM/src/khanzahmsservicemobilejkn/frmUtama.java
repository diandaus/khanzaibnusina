                                            ...
                                            if(Sequel.menyimpantf2("referensi_mobilejkn_bpjs_taskid","?,?,?","task id",3,new String[]{rs.getString("no_rawat"),"99",datajam})==true){
                                                ...
                                                try {     
                                                    ...
                                                    if(!nameNode.path("code").asText().equals("200")){
                                                        ...
                                                        Sequel.queryu2("delete from reg_periksa where no_rawat='"+rs.getString("no_rawat_batal")+"'");
                                                     // DELETE FROM `reg_periksa` WHERE `no_rawat`='2024/02/24/000001'
                        ...
                        try {
                            ...
                            while(rs.next()){
                                ...
                                if(task6.equals("")){
                                    ...
                                    if(noresep.equals("")){
                                        task5=Sequel.cariIsi("select referensi_mobilejkn_bpjs_taskid.taskid from referensi_mobilejkn_bpjs_taskid where referensi_mobilejkn_bpjs_taskid.no_rawat=? and referensi_mobilejkn_bpjs_taskid.taskid='5'",rs.getString("no_rawat"));
                                    }
                                    if(!task5.equals("")){
                                        try {     
