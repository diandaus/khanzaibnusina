...
public class DlgPermintaanResepPulangBackup extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgPermintaanResepPulangBackup(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgPermintaanResepPulangBackup dialog = new DlgPermintaanResepPulangBackup(new javax.swing.JFrame(), true);
