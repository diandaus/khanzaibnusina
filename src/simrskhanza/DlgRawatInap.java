...
import rekammedis.RMRiwayatAwalMedisIGD;
...
public final class DlgRawatInap extends javax.swing.JDialog {
        ...
        soapterakhiradime.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if(soapterakhiradime.getTable().getSelectedRow()!= -1){   
                    TKeluhan1.setText(soapterakhiradime.getTable().getValueAt(soapterakhiradime.getTable().getSelectedRow(),2).toString());
                    TPemeriksaan1.setText(soapterakhiradime.getTable().getValueAt(soapterakhiradime.getTable().getSelectedRow(),3).toString());
                    TPenilaian1.setText(soapterakhiradime.getTable().getValueAt(soapterakhiradime.getTable().getSelectedRow(),4).toString());
                    TindakLanjut1.setText(soapterakhiradime.getTable().getValueAt(soapterakhiradime.getTable().getSelectedRow(),5).toString());
                    TInstruksi1.setText(soapterakhiradime.getTable().getValueAt(soapterakhiradime.getTable().getSelectedRow(),6).toString());
                    TEvaluasi1.setText(soapterakhiradime.getTable().getValueAt(soapterakhiradime.getTable().getSelectedRow(),7).toString());
                    TEvaluasi1.requestFocus();                    
                }        
            }
            @Override
            public void windowIconified(WindowEvent e) {}
    ...
    private void initComponents() {
        ...
        BtnHasilAwalMedis1 = new widget.Button();
        BtnHasilRadiologi1 = new widget.Button();
        ...
        PanelInput1.setPreferredSize(new java.awt.Dimension(192, 350));
        ...
        scrollPane1.setBounds(73, 70, 360, 74);
        ...
        scrollPane2.setBounds(73, 148, 360, 80);
        ...
        scrollPane3.setBounds(540, 40, 360, 70);
        ...
        jLabel26.setBounds(450, 120, 90, 23);
        ...
        scrollPane4.setBounds(540, 120, 360, 60);
        ...
        jLabel55.setBounds(450, 190, 90, 23);
        ...
        scrollPane7.setBounds(540, 190, 360, 60);

        jLabel56.setText("SpO2 (%) :");
        jLabel56.setName("jLabel56"); // NOI18N
        panelGlass12.add(jLabel56);
        jLabel56.setBounds(10, 300, 70, 23);
        ...
        SpO2.setBounds(80, 300, 42, 23);

        jLabel22.setText("GCS (E,V,M) :");
        jLabel22.setName("jLabel22"); // NOI18N
        panelGlass12.add(jLabel22);
        jLabel22.setBounds(130, 300, 70, 23);
        ...
        TGCS.setBounds(200, 300, 42, 23);

        jLabel58.setText("Kesadaran :");
        jLabel58.setName("jLabel58"); // NOI18N
        panelGlass12.add(jLabel58);
        jLabel58.setBounds(240, 300, 70, 23);
        ...
        cmbKesadaran.setBounds(310, 300, 126, 23);
        ...
        scrollPane8.setBounds(540, 258, 360, 60);

        jLabel59.setText("Evaluasi :");
        jLabel59.setName("jLabel59"); // NOI18N
        panelGlass12.add(jLabel59);
        jLabel59.setBounds(450, 260, 90, 23);
        ...
        jLabel7.setBounds(10, 240, 70, 23);
        ...
        TSuhu.setBounds(80, 240, 55, 23);

        jLabel17.setText("TB (Cm) :");
        jLabel17.setName("jLabel17"); // NOI18N
        panelGlass12.add(jLabel17);
        jLabel17.setBounds(10, 270, 70, 23);
        ...
        TTinggi.setBounds(80, 270, 55, 23);

        jLabel4.setText("Tensi (mmHg) :");
        jLabel4.setName("jLabel4"); // NOI18N
        panelGlass12.add(jLabel4);
        jLabel4.setBounds(140, 240, 90, 23);
        ...
        TTensi.setBounds(230, 240, 74, 23);
        ...
        TBerat.setBounds(380, 240, 55, 23);
        ...
        TNadi.setBounds(380, 270, 55, 23);

        jLabel61.setText("Nadi (/menit) :");
        jLabel61.setName("jLabel61"); // NOI18N
        panelGlass12.add(jLabel61);
        jLabel61.setBounds(300, 270, 79, 23);

        BtnInputKonsul.setForeground(new java.awt.Color(0, 0, 0));
        BtnInputKonsul.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/EDIT2.png"))); // NOI18N
        ...
        BtnInputKonsul.setBounds(910, 130, 160, 30);

        BtnInputKonsul1.setForeground(new java.awt.Color(0, 0, 0));
        BtnInputKonsul1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/Doctor.png"))); // NOI18N
        BtnInputKonsul1.setMnemonic('4');
        BtnInputKonsul1.setText("Verifikasi SOAP/CPPT");
        ...
        BtnTemplateResep.setBounds(910, 10, 160, 30);
        ...
        BtnTemplatePemberianObat.setBounds(1080, 10, 160, 30);
        ...
        BtnBalanceCairan.setBounds(910, 170, 160, 30);
        ...
        BtnHasilRadiologi.setBounds(1080, 50, 160, 26);
        ...
        BtnHasilPengobatan.setBounds(1080, 90, 160, 26);
        ...
        BtnHasilPengobatan1.setBounds(1080, 130, 160, 26);
        ...
        BtnInputKonsul2.setBounds(1080, 170, 160, 26);

        BtnHasilAwalMedis.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/edit_f2.png"))); // NOI18N
        BtnHasilAwalMedis.setMnemonic('4');
        BtnHasilAwalMedis.setText("Awal Medis IGD");
        BtnHasilAwalMedis.setToolTipText("");
        BtnHasilAwalMedis.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnHasilAwalMedis.setGlassColor(new java.awt.Color(255, 153, 153));
        BtnHasilAwalMedis.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnHasilAwalMedis.setName("BtnHasilAwalMedis"); // NOI18N
        BtnHasilAwalMedis.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnHasilAwalMedisActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnHasilAwalMedis);
        BtnHasilAwalMedis.setBounds(910, 210, 160, 26);

        BtnInputBacaanEKG.setForeground(new java.awt.Color(0, 0, 0));
        BtnInputBacaanEKG.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/Edit.png"))); // NOI18N
        BtnInputBacaanEKG.setMnemonic('4');
        BtnInputBacaanEKG.setText("Hasil Pemeriksaan EKG");
        BtnInputBacaanEKG.setToolTipText("");
        BtnInputBacaanEKG.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnInputBacaanEKG.setGlassColor(new java.awt.Color(255, 153, 153));
        BtnInputBacaanEKG.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnInputBacaanEKG.setName("BtnInputBacaanEKG"); // NOI18N
        BtnInputBacaanEKG.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnInputBacaanEKGActionPerformed(evt);
            }
        });
        ...
        PanelInput6.setPreferredSize(new java.awt.Dimension(192, 308));
        ...
        BtnHasilAwalMedis1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/edit_f2.png"))); // NOI18N
        BtnHasilAwalMedis1.setMnemonic('4');
        BtnHasilAwalMedis1.setText("Awal Medis IGD");
        BtnHasilAwalMedis1.setToolTipText("");
        BtnHasilAwalMedis1.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnHasilAwalMedis1.setGlassColor(new java.awt.Color(255, 153, 153));
        BtnHasilAwalMedis1.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnHasilAwalMedis1.setName("BtnHasilAwalMedis1"); // NOI18N
        BtnHasilAwalMedis1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnHasilAwalMedis1ActionPerformed(evt);
            }
        });
        panelGlass18.add(BtnHasilAwalMedis1);
        BtnHasilAwalMedis1.setBounds(980, 80, 160, 26);

        BtnHasilRadiologi1.setForeground(new java.awt.Color(0, 0, 0));
        BtnHasilRadiologi1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/TestTubes.png"))); // NOI18N
        BtnHasilRadiologi1.setMnemonic('4');
        BtnHasilRadiologi1.setText("Riwayat Penunjang");
        BtnHasilRadiologi1.setToolTipText("");
        BtnHasilRadiologi1.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnHasilRadiologi1.setGlassColor(new java.awt.Color(255, 153, 153));
        BtnHasilRadiologi1.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnHasilRadiologi1.setName("BtnHasilRadiologi1"); // NOI18N
        BtnHasilRadiologi1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnHasilRadiologi1ActionPerformed(evt);
            }
        });
        panelGlass18.add(BtnHasilRadiologi1);
        BtnHasilRadiologi1.setBounds(980, 40, 160, 26);
        ...
        jLabel65.setBounds(1160, 10, 50, 23);
        ...
        Partograf.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        Partograf.setText("Partograf");
        Partograf.setFocusPainted(false);
        Partograf.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        Partograf.setGlassColor(new java.awt.Color(255, 255, 255));
        Partograf.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        Partograf.setMargin(new java.awt.Insets(1, 1, 1, 1));
        Partograf.setName("Partograf"); // NOI18N
        Partograf.setPreferredSize(new java.awt.Dimension(190, 23));
        Partograf.setRoundRect(false);
        Partograf.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                PartografActionPerformed(evt);
            }
        });
        FormMenu.add(Partograf);
            ...
            case 3:
                if(tabModePemeriksaan.getRowCount()==0){
                    ...
                    Valid.MyReportqry("rptInapPemeriksaan.jasper","report","::[ Data Pemeriksaan Rawat Inap ]::",
                            ...
                            "pemeriksaan_ranap.instruksi,pemeriksaan_ranap.evaluasi,pemeriksaan_ranap.nip,pegawai.nama,pegawai.nama as qrnama "+
                ...
                case 5:
                   if((!TInspeksi.getText().trim().equals(""))||(!TInspeksiVulva.getText().trim().equals(""))||
                    ...
                    if((!TKeluhan1.getText().trim().equals(""))||(!TPemeriksaan1.getText().trim().equals(""))||(!TSuhu1.getText().trim().equals(""))||
                            ...
                            (!TBerat1.getText().trim().equals(""))||(!TRespirasi1.getText().trim().equals(""))||(!TNadi1.getText().trim().equals(""))||
                            (!TGCS1.getText().trim().equals(""))||(!TindakLanjut1.getText().trim().equals(""))||(!TPenilaian1.getText().trim().equals(""))||
                            (!KdPeg1.getText().trim().equals(""))||(!TPegawai1.getText().trim().equals(""))||(!TInstruksi1.getText().trim().equals(""))||
                            (!SpO3.getText().trim().equals(""))||(!TEvaluasi1.getText().trim().equals(""))){
                        if(tbPemeriksaan1.getSelectedRow()>-1){
                            if(akses.getkode().equals("Admin Utama")){
                                Sequel.mengedit("pemeriksaan_ranap","no_rawat='"+tbPemeriksaan1.getValueAt(tbPemeriksaan1.getSelectedRow(),1)+
                                    ...
                                    "keluhan='"+TKeluhan1.getText()+"',pemeriksaan='"+TPemeriksaan1.getText()+"',spo2='"+SpO3.getText()+"',"+
                                    ...
                                    "jam_rawat='"+cmbJam.getSelectedItem()+":"+cmbMnt.getSelectedItem()+":"+cmbDtk.getSelectedItem()+"',"+
                                    "rtl='"+TindakLanjut1.getText()+"',penilaian='"+TPenilaian1.getText()+"',instruksi='"+TInstruksi1.getText()+"',evaluasi='"+TEvaluasi1.getText()+"',nip='"+KdPeg1.getText()+"'");
                                tampilPemeriksaanAdime();
                                BtnBatalActionPerformed(evt);
                            }else{
                                if(akses.getkode().equals(tbPemeriksaan1.getValueAt(tbPemeriksaan1.getSelectedRow(),22).toString())){
                                    Sequel.mengedit("pemeriksaan_ranap","no_rawat='"+tbPemeriksaan1.getValueAt(tbPemeriksaan1.getSelectedRow(),1)+
                                        ...
                                        "gcs='"+TGCS1.getText()+"',kesadaran='"+cmbKesadaran1.getSelectedItem()+"',alergi='"+TAlergi1.getText()+"',tgl_perawatan='"+Valid.SetTgl(DTPTgl.getSelectedItem()+"")+"',"+
                                        "jam_rawat='"+cmbJam.getSelectedItem()+":"+cmbMnt.getSelectedItem()+":"+cmbDtk.getSelectedItem()+"',"+
                                        "rtl='"+TindakLanjut1.getText()+"',penilaian='"+TPenilaian1.getText()+"',instruksi='"+TInstruksi1.getText()+"',evaluasi='"+TEvaluasi1.getText()+"'");
                                    tampilPemeriksaanAdime();
                                    BtnBatalActionPerformed(evt);
                                }else{
                                    JOptionPane.showMessageDialog(null,"Hanya bisa diganti oleh dokter/petugas yang bersangkutan..!!");
...
private void BtnEditKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnEditKeyPressed
    ...
    private void PartografActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PartografActionPerformed
         if(TPasien.getText().trim().equals("")||TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            RMDataPartograf form=new RMDataPartograf(null,false);
            form.isCek();
            form.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
            form.setLocationRelativeTo(internalFrame1);
            form.setVisible(true);
    ...
    }//GEN-LAST:event_PartografActionPerformed
    ...
    private void BtnHasilAwalMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHasilAwalMedisActionPerformed
  if(TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu pasien...!!!");
            TCari.requestFocus();
        }else{
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            RMRiwayatAwalMedisIGD resume=new RMRiwayatAwalMedisIGD(null,true);
            resume.setNoRm(TNoRM.getText(),TPasien.getText());
            resume.setSize(internalFrame1.getWidth(),internalFrame1.getHeight());
            resume.setLocationRelativeTo(internalFrame1);
            resume.setVisible(true);
...
// TODO add your handling code here:
    }//GEN-LAST:event_BtnHasilAwalMedisActionPerformed

    private void BtnInputBacaanEKGActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnInputBacaanEKGActionPerformed
    ...
    }//GEN-LAST:event_BtnInputBacaanEKGActionPerformed

    private void BtnHasilAwalMedis1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHasilAwalMedis1ActionPerformed
         if(TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu pasien...!!!");
            TCari.requestFocus();
        }else{
    ...
    }//GEN-LAST:event_BtnHasilAwalMedis1ActionPerformed

    private void BtnHasilRadiologi1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHasilRadiologi1ActionPerformed
              if(TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu pasien...!!!");
            TCari.requestFocus();
        }else{
    ...
    */
    ...
    private widget.Button Partograf;
