 ...
 * @author perpustakaan
 */
public final class DlgBerkasKlaimBpjs extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgBerkasKlaimBpjs(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        initRawatInap();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgBerkasKlaimBpjs dialog = new DlgBerkasKlaimBpjs(new javax.swing.JFrame(), true);
