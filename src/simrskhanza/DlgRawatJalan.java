...
public final class DlgRawatJalan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        BtnOdontogram.setBounds(920, 40, 160, 30);
        ...
        BtnTemplateResep.setBounds(1100, 100, 200, 30);
        ...
        BtnTemplatePemberianObat.setBounds(1100, 130, 200, 30);
        ...
        BtnTemplatePemberianObat1.setBounds(920, 160, 160, 30);
        ...
        BtnHasilPengobatan1.setBounds(920, 130, 160, 26);
        ...
        BtnInputLAB.setBounds(920, 190, 160, 26);
        ...
        BtnInputRAD.setBounds(920, 220, 160, 26);
        ...
        BtnInputTerimaPasienAntarRuang.setBounds(1100, 40, 200, 26);
        ...
        BtnInputKonsul1.setBounds(1100, 70, 200, 26);
        ...
        BtnInputBacaanEKG.setBounds(1100, 160, 200, 30);

        BtnRiwayatFKTP.setForeground(new java.awt.Color(0, 0, 0));
        BtnRiwayatFKTP.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/iCare(4).png"))); // NOI18N
        ...
        BtnRiwayatFKTP.setBounds(1100, 190, 200, 30);
    ...
    private void BtnKeluarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnKeluarActionPerformed
        ...
        try {
            ...
            if(i==JOptionPane.YES_OPTION){
                ...
                Sequel.mengedit("reg_periksa","no_rawat=?","stts=?",2,new String[]{"TTV",TNoRw.getText()});
            }
        } catch (Exception e) {
        }
        dispose();
    ...
    */
    ...
    private void tampilSoapPerawat(){
        if(Sequel.cariInteger("select count(no_rawat) from pemeriksaan_ralan where no_rawat='"+TNoRw.getText()+"' ")>0){ 
            ...
            TRespirasi.setText(Sequel.cariIsi("select spo2 from pemeriksaan_ralan where no_rawat=?",TNoRw.getText())); 
...
//            emptTeks();
    ...
    private void gantiCatatanPerawatIGD() {
        ...
        if(tabModeCatatanPerawatIGD.getRowCount()!=0){tampilCatatanPerawatIGD();}
//        emptTeks();
    }
