...
public class DlgCariPeriksaRadiologiBackup extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgCariPeriksaRadiologiBackup(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
   ...
   if(tabMode.getRowCount()!=0){
    ...
    private void BtnPrint1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint1ActionPerformed
        if(Kd2.getText().equals("")){
            ...
            new Object[]{"Model 1","PDF Model 1","Send Dokument","Tanda Tangan","Download Dokumen TTE"},"Model 1");
            switch (pilihan) {
                case "Model 1":
                      Valid.MyReport("rptPeriksaRadiologiTTE.jasper","report","::[ Pemeriksaan Radiologi ]::",param);
                      break;
                case "PDF Model 1":
                      Valid.MyReportPDF("rptPeriksaRadiologiTTE.jasper","report","::[ Pemeriksaan Radiologi ]::",param);
                      break;
                case "Send Dokument":
                        try {
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCariPeriksaRadiologiBackup dialog = new DlgCariPeriksaRadiologiBackup(new javax.swing.JFrame(), true);
