...
//                        rs.getString("kd_instrumen"),rs.getString("nm_instrumen"),
//                        rs.getString("jumlah_awal"),rs.getString("jumlah_akhir"),rs.getString("keterangan")
                    });
                    tabMode.addRow(new String[]{"","","Kode Instrumen","Nama Instrumen","Jumlah Awal","Jumlah Akhir","Keterangan"});                
                    ...
                    "beri_instrumen_ok.kd_instrumen, beri_instrumen_ok.keterangan " +
                    ...
                    try {
                        ...
                        while(rs2.next()){
                            tabMode.addRow(new String[]{
                                "","",rs2.getString("kd_instrumen"),rs2.getString("nm_instrumen"),rs2.getString("jumlah_awal"),rs2.getString("jumlah_akhir"),rs2.getString("keterangan")
                            });
                        }
                    } catch (Exception e) {
