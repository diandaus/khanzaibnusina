...
public final class RMStatusNeurologi extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "08-02-2024" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "08-02-2024" }));
        ...
        Tanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "08-02-2024" }));
        ...
        FormInput.add(HR);
        HR.setBounds(620, 70, 90, 23);

        jLabel20.setText("Pupil kiri:");
        jLabel20.setName("jLabel20"); // NOI18N
        FormInput.add(jLabel20);
        jLabel20.setBounds(570, 70, 50, 23);

        jLabel22.setText("Ektremitas Superior Kanan:");
        jLabel22.setName("jLabel22"); // NOI18N
        FormInput.add(jLabel22);
        jLabel22.setBounds(220, 100, 150, 23);
        ...
        FormInput.add(Suhu);
        Suhu.setBounds(380, 100, 100, 23);

        jLabel23.setText("Pupil Kanan:");
        jLabel23.setName("jLabel23"); // NOI18N
        FormInput.add(jLabel23);
        jLabel23.setBounds(400, 70, 80, 23);
        ...
        jLabel29.setBounds(500, 100, 118, 23);
        ...
        FormInput.add(GCS1);
        GCS1.setBounds(170, 70, 50, 23);

        jLabel13.setText("V:");
        jLabel13.setName("jLabel13"); // NOI18N
        FormInput.add(jLabel13);
        jLabel13.setBounds(140, 70, 30, 23);
        ...
        FormInput.add(GCS2);
        GCS2.setBounds(260, 70, 50, 23);

        jLabel14.setText("M:");
        jLabel14.setName("jLabel14"); // NOI18N
        FormInput.add(jLabel14);
        jLabel14.setBounds(230, 70, 30, 23);
        ...
        FormInput.add(GCS3);
        GCS3.setBounds(350, 70, 50, 23);

        jLabel15.setText("Total:");
        jLabel15.setName("jLabel15"); // NOI18N
        FormInput.add(jLabel15);
        jLabel15.setBounds(320, 70, 30, 23);

        jLabel24.setText("Ektremitas Inferior Kanan:");
        jLabel24.setName("jLabel24"); // NOI18N
        FormInput.add(jLabel24);
        jLabel24.setBounds(0, 130, 150, 23);
        ...
        FormInput.add(Suhu1);
        Suhu1.setBounds(150, 130, 100, 23);

        jLabel30.setText("Ekstremitas Inferior kiri:");
        jLabel30.setName("jLabel30"); // NOI18N
        FormInput.add(jLabel30);
        jLabel30.setBounds(270, 130, 114, 23);
        ...
        FormInput.add(SPO1);
        SPO1.setBounds(400, 130, 70, 23);

        jLabel31.setText("Kesadaran:");
        jLabel31.setName("jLabel31"); // NOI18N
        FormInput.add(jLabel31);
        jLabel31.setBounds(490, 130, 55, 23);
