 ...
 * @author perpustakaan
 */
public final class RMDataPartograf extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMDataPartograf(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel12.setText("Air Ketuban:");
        jLabel12.setName("jLabel12"); // NOI18N
        FormInput.add(jLabel12);
        jLabel12.setBounds(150, 70, 60, 23);
        ...
        FormInput.add(HR);
        HR.setBounds(330, 100, 60, 23);

        jLabel20.setText("Oksitosin:");
        jLabel20.setName("jLabel20"); // NOI18N
        FormInput.add(jLabel20);
        jLabel20.setBounds(270, 100, 50, 23);

        jLabel22.setText("Suhu :");
        jLabel22.setName("jLabel22"); // NOI18N
        FormInput.add(jLabel22);
        jLabel22.setBounds(770, 100, 40, 23);
        ...
        FormInput.add(Suhu);
        Suhu.setBounds(810, 100, 40, 23);

        jLabel23.setText("TD :");
        jLabel23.setName("jLabel23"); // NOI18N
        FormInput.add(jLabel23);
        jLabel23.setBounds(600, 100, 40, 23);
        ...
        FormInput.add(TD);
        TD.setBounds(650, 100, 70, 23);

        jLabel26.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel26.setText("°C");
        jLabel26.setName("jLabel26"); // NOI18N
        FormInput.add(jLabel26);
        jLabel26.setBounds(850, 100, 30, 23);

        jLabel27.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel27.setText("mmHg");
        jLabel27.setName("jLabel27"); // NOI18N
        FormInput.add(jLabel27);
        jLabel27.setBounds(730, 100, 40, 23);
        ...
        FormInput.add(RR);
        RR.setBounds(510, 100, 90, 23);

        jLabel28.setText("Obat dan Cairan IV:");
        jLabel28.setName("jLabel28"); // NOI18N
        FormInput.add(jLabel28);
        jLabel28.setBounds(400, 100, 100, 23);

        jLabel29.setText("Penyusupan :");
        jLabel29.setName("jLabel29"); // NOI18N
        FormInput.add(jLabel29);
        jLabel29.setBounds(280, 70, 70, 23);
        ...
        jLabel24.setBounds(40, 70, 40, 23);
        ...
        FormInput.add(PPV);
        PPV.setBounds(480, 70, 100, 23);

        jLabel30.setText("Pembukaan:");
        jLabel30.setName("jLabel30"); // NOI18N
        FormInput.add(jLabel30);
        jLabel30.setBounds(410, 70, 60, 23);

        jLabel31.setText("Penurunan Kepala:");
        jLabel31.setName("jLabel31"); // NOI18N
        FormInput.add(jLabel31);
        jLabel31.setBounds(580, 70, 100, 23);
        ...
        FormInput.add(VT);
        VT.setBounds(690, 70, 90, 23);

        jLabel32.setText("Urin Protein:");
        jLabel32.setName("jLabel32"); // NOI18N
        FormInput.add(jLabel32);
        jLabel32.setBounds(0, 130, 100, 23);
        ...
        FormInput.add(RR1);
        RR1.setBounds(110, 130, 90, 23);

        jLabel25.setText("Aseton:");
        jLabel25.setName("jLabel25"); // NOI18N
        FormInput.add(jLabel25);
        jLabel25.setBounds(210, 130, 40, 23);
        ...
        FormInput.add(TD1);
        TD1.setBounds(260, 130, 70, 23);

        jLabel34.setText("Volume:");
        jLabel34.setName("jLabel34"); // NOI18N
        FormInput.add(jLabel34);
        jLabel34.setBounds(350, 130, 40, 23);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMDataPartograf dialog = new RMDataPartograf(new javax.swing.JFrame(), true);
