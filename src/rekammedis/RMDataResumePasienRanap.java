   ...
   // private RMCariLabPending carilabpending=new RMCariLabPending(null,false);
    ...
    public RMDataResumePasienRanap(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            ...
            "Keluhan Utama Riwayat Penyakit","Pemeriksaan Fisik","Pemeriksaan Penunjang Rad Terpenting",
            ...
            "Diagnosa Sekunder 4","ICD10 Sek 4","Diagnosa Sekunder 5","ICD10 Sek 5","Prosedur Utama","ICD9 Utama","Prosedur Sekunder 1","ICD9 Sek1","Prosedur Sekunder 2",
            "ICD9 Sek2","Prosedur Sekunder 3","ICD9 Sek3","Prosedur Sekunder 4",
            "ICD9 Sek4","Prosedur Sekunder 5","ICD9 Sek5","Konsul Dokter",
            "Instruksi/Anjuran Dan Edukasi (Follow Up)","Keadaan Pulang","Ket.Keadaan Pulang","Cara Keluar","Ket.Cara Keluar",
            "Obat Pulang","Kode Bayar","Cara Bayar"
        }){
        ...
        DiagnosaSekunder5.setDocument(new batasInput((int)500).getKata(DiagnosaSekunder5));
        ...
        ProsedurSekunder4.setDocument(new batasInput((int)500).getKata(ProsedurSekunder4));
        ProsedurSekunder5.setDocument(new batasInput((int)500).getKata(ProsedurSekunder5));
        ...
        KonsulDokter.setDocument(new batasInput((int)200).getKata(KonsulDokter));
...
//                }
    ...
    private void initComponents() {
        ...
        MnSendDokument = new javax.swing.JMenuItem();
        MnSendOTP = new javax.swing.JMenuItem();
        MnTTEDokumen = new javax.swing.JMenuItem();
        MnDowloadDokumen = new javax.swing.JMenuItem();
        ...
        KonsulDokter = new widget.TextBox();
        ...
        MnSendDokument.setBackground(new java.awt.Color(255, 255, 254));
        MnSendDokument.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnSendDokument.setForeground(new java.awt.Color(50, 50, 50));
        MnSendDokument.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnSendDokument.setText("Send Dokumen");
        MnSendDokument.setName("MnSendDokument"); // NOI18N
        MnSendDokument.setPreferredSize(new java.awt.Dimension(220, 26));
        MnSendDokument.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnSendDokumentActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnSendDokument);

        MnSendOTP.setBackground(new java.awt.Color(255, 255, 254));
        MnSendOTP.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnSendOTP.setForeground(new java.awt.Color(50, 50, 50));
        MnSendOTP.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnSendOTP.setText("Send & Validasi OTP");
        MnSendOTP.setName("MnSendOTP"); // NOI18N
        MnSendOTP.setPreferredSize(new java.awt.Dimension(220, 26));
        MnSendOTP.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnSendOTPActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnSendOTP);

        MnTTEDokumen.setBackground(new java.awt.Color(255, 255, 254));
        MnTTEDokumen.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnTTEDokumen.setForeground(new java.awt.Color(50, 50, 50));
        MnTTEDokumen.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnTTEDokumen.setText("TTE Dokumen");
        MnTTEDokumen.setName("MnTTEDokumen"); // NOI18N
        MnTTEDokumen.setPreferredSize(new java.awt.Dimension(220, 26));
        MnTTEDokumen.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnTTEDokumenActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnTTEDokumen);

        MnDowloadDokumen.setBackground(new java.awt.Color(255, 255, 254));
        MnDowloadDokumen.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnDowloadDokumen.setForeground(new java.awt.Color(50, 50, 50));
        MnDowloadDokumen.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnDowloadDokumen.setText("Download Dokumen TTE");
        MnDowloadDokumen.setName("MnDowloadDokumen"); // NOI18N
        MnDowloadDokumen.setPreferredSize(new java.awt.Dimension(220, 26));
        MnDowloadDokumen.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnDowloadDokumenActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnDowloadDokumen);
        ...
        jLabel25.setBounds(0, 660, 145, 23);
        ...
        DiagnosaSekunder2.setBounds(150, 660, 520, 23);

        jLabel26.setText("Diagnosa Sekunder 3 :");
        jLabel26.setName("jLabel26"); // NOI18N
        FormInput.add(jLabel26);
        jLabel26.setBounds(0, 690, 145, 23);
        ...
        DiagnosaUtama.setBounds(150, 600, 520, 23);

        jLabel27.setText("Diagnosa Utama :");
        jLabel27.setName("jLabel27"); // NOI18N
        FormInput.add(jLabel27);
        jLabel27.setBounds(0, 600, 145, 23);
        ...
        DiagnosaSekunder3.setBounds(150, 690, 520, 23);

        jLabel28.setText("Diagnosa Sekunder 4 :");
        jLabel28.setName("jLabel28"); // NOI18N
        FormInput.add(jLabel28);
        jLabel28.setBounds(0, 720, 145, 23);
        ...
        DiagnosaSekunder4.setBounds(150, 720, 520, 23);
        ...
        scrollPane2.setBounds(220, 160, 561, 74);
        ...
        jLabel8.setBounds(0, 240, 220, 23);
        ...
        scrollPane3.setBounds(220, 240, 561, 74);

        jLabel9.setText("Pemeriksaan Penunjang Rad Terpenting :");
        jLabel9.setName("jLabel9"); // NOI18N
        FormInput.add(jLabel9);
        jLabel9.setBounds(0, 320, 220, 23);
        ...
        scrollPane4.setBounds(220, 320, 561, 74);

        jLabel10.setText("Pemeriksaan Penunjang Lab Terpenting :");
        jLabel10.setName("jLabel10"); // NOI18N
        FormInput.add(jLabel10);
        jLabel10.setBounds(0, 400, 220, 23);
        ...
        scrollPane5.setBounds(220, 400, 561, 80);

        jLabel29.setText("Diagnosa Akhir :");
        jLabel29.setName("jLabel29"); // NOI18N
        FormInput.add(jLabel29);
        jLabel29.setBounds(0, 580, 100, 23);

        jLabel30.setText("Diagnosa Sekunder 1 :");
        jLabel30.setName("jLabel30"); // NOI18N
        FormInput.add(jLabel30);
        jLabel30.setBounds(0, 630, 145, 23);
        ...
        DiagnosaSekunder1.setBounds(150, 630, 520, 23);

        jLabel31.setText("Kode ICD :");
        jLabel31.setName("jLabel31"); // NOI18N
        FormInput.add(jLabel31);
        jLabel31.setBounds(560, 580, 210, 23);
        ...
        KodeDiagnosaUtama.setBounds(710, 600, 75, 23);
        ...
        KodeDiagnosaSekunder1.setBounds(710, 630, 75, 23);
        ...
        KodeDiagnosaSekunder2.setBounds(710, 660, 75, 23);
        ...
        KodeDiagnosaSekunder3.setBounds(710, 690, 75, 23);
        ...
        KodeDiagnosaSekunder4.setBounds(710, 720, 75, 23);

        jLabel32.setText("Prosedur Utama :");
        jLabel32.setName("jLabel32"); // NOI18N
        FormInput.add(jLabel32);
        jLabel32.setBounds(0, 790, 145, 23);
        ...
        ProsedurUtama.setBounds(150, 790, 520, 23);
        ...
        KodeProsedurUtama.setBounds(710, 790, 75, 23);
        ...
        ProsedurSekunder1.setBounds(150, 820, 520, 23);

        jLabel33.setText("Prosedur Sekunder 1 :");
        jLabel33.setName("jLabel33"); // NOI18N
        FormInput.add(jLabel33);
        jLabel33.setBounds(0, 820, 145, 23);
        ...
        KodeProsedurSekunder1.setBounds(710, 820, 75, 23);

        jLabel34.setText("Prosedur Sekunder 2 :");
        jLabel34.setName("jLabel34"); // NOI18N
        FormInput.add(jLabel34);
        jLabel34.setBounds(0, 850, 145, 23);
        ...
        ProsedurSekunder2.setBounds(150, 850, 520, 23);
        ...
        KodeProsedurSekunder2.setBounds(710, 850, 75, 23);
        ...
        KodeProsedurSekunder3.setBounds(710, 880, 75, 23);
        ...
        ProsedurSekunder3.setBounds(150, 880, 520, 23);

        jLabel35.setText("Prosedur Sekunder 3 :");
        jLabel35.setName("jLabel35"); // NOI18N
        FormInput.add(jLabel35);
        jLabel35.setBounds(0, 880, 145, 23);
        ...
        BtnDokter1.setBounds(190, 180, 28, 23);
        ...
        BtnDokter2.setBounds(190, 340, 28, 23);
        ...
        BtnDokter3.setBounds(190, 420, 28, 23);

        jLabel37.setText("Cara Keluar :");
        jLabel37.setName("jLabel37"); // NOI18N
        FormInput.add(jLabel37);
        jLabel37.setBounds(380, 1080, 70, 23);

        CaraKeluar.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Atas Izin Dokter", "Rujuk", "Pulang Atas Permintaan Sendiri", "Kabur", "-" }));
        ...
        CaraKeluar.setBounds(450, 1080, 205, 23);

        jLabel36.setText("Keadaan Pulang :");
        jLabel36.setName("jLabel36"); // NOI18N
        FormInput.add(jLabel36);
        jLabel36.setBounds(0, 1080, 100, 23);

        Keadaan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Sembuh", "Tidak Sembuh", "Perbaikan", "Meninggal" }));
        ...
        Keadaan.setBounds(100, 1080, 130, 23);
        ...
        BtnDokter5.setBounds(190, 260, 28, 23);
        ...
        jLabel38.setText("Konsul Dokter :");
        jLabel38.setName("jLabel38"); // NOI18N
        FormInput.add(jLabel38);
        jLabel38.setBounds(130, 980, 100, 23);

        KonsulDokter.setHighlighter(null);
        KonsulDokter.setName("KonsulDokter"); // NOI18N
        KonsulDokter.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                KonsulDokterKeyPressed(evt);
            }
        });
        FormInput.add(KonsulDokter);
        KonsulDokter.setBounds(230, 980, 330, 23);
        ...
        KetKeluar.setBounds(660, 1080, 125, 23);

        jLabel41.setText("Instruksi/Anjuran Dan Edukasi (Follow Up) :");
        jLabel41.setName("jLabel41"); // NOI18N
        FormInput.add(jLabel41);
        jLabel41.setBounds(0, 1020, 230, 23);
        ...
        scrollPane9.setBounds(230, 1020, 551, 50);
        ...
        KetKeadaanPulang.setBounds(240, 1080, 130, 23);
        ...
        BtnDokter20.setBounds(190, 510, 28, 23);
        ...
        scrollPane12.setBounds(220, 490, 561, 80);

        jLabel13.setText("Obat-obatan Selama Perawatan :");
        jLabel13.setName("jLabel13"); // NOI18N
        FormInput.add(jLabel13);
        jLabel13.setBounds(0, 490, 220, 23);
        ...
        BtnDiagnosa.setBounds(790, 600, 28, 23);

        jLabel43.setText("Prosedur Sekunder 4 :");
        jLabel43.setName("jLabel43"); // NOI18N
        FormInput.add(jLabel43);
        jLabel43.setBounds(0, 910, 145, 23);
        ...
        ProsedurSekunder4.setBounds(150, 910, 520, 23);
        ...
        KodeProsedurSekunder4.setBounds(710, 910, 75, 23);
        ...
        KodeProsedurSekunder5.setBounds(710, 940, 75, 23);
        ...
        ProsedurSekunder5.setBounds(150, 940, 520, 23);

        jLabel44.setText("Prosedur Sekunder 5 :");
        jLabel44.setName("jLabel44"); // NOI18N
        FormInput.add(jLabel44);
        jLabel44.setBounds(0, 940, 145, 23);

        jLabel45.setText("Diagnosa Sekunder 5 :");
        jLabel45.setName("jLabel45"); // NOI18N
        FormInput.add(jLabel45);
        jLabel45.setBounds(0, 750, 145, 23);
        ...
        DiagnosaSekunder5.setBounds(150, 750, 520, 23);
        ...
        KodeDiagnosaSekunder5.setBounds(710, 750, 75, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        /*}else if(JalannyaPenyakit.getText().isEmpty()){
            ...
            if(Sequel.menyimpantf("resume_pasien_ranap","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",40,new String[]{
                    ...
                    KodeDiagnosaSekunder3.getText(),DiagnosaSekunder4.getText(),KodeDiagnosaSekunder4.getText(),DiagnosaSekunder5.getText(),KodeDiagnosaSekunder5.getText(),ProsedurUtama.getText(),KodeProsedurUtama.getText(),
                    ProsedurSekunder1.getText(),KodeProsedurSekunder1.getText(),ProsedurSekunder2.getText(),KodeProsedurSekunder2.getText(),ProsedurSekunder3.getText(),KodeProsedurSekunder3.getText(),
                    ProsedurSekunder5.getText(),KodeProsedurSekunder5.getText(),ProsedurSekunder5.getText(),KodeProsedurSekunder5.getText(),KonsulDokter.getText(),Edukasi.getText(),CaraKeluar.getSelectedItem().toString(),KetKeluar.getText(),
                    ...
                    tabMode.addRow(new String[]{
                        ...
                        KeluhanUtama.getText(),PemeriksaanFisik.getText(),PemeriksaanRad.getText(),HasilLaborat.getText(),
                        ...
                        KodeDiagnosaSekunder2.getText(),DiagnosaSekunder3.getText(),KodeDiagnosaSekunder3.getText(),DiagnosaSekunder4.getText(),KodeDiagnosaSekunder4.getText(),DiagnosaSekunder5.getText(),KodeDiagnosaSekunder5.getText(),
                        ProsedurUtama.getText(),KodeProsedurUtama.getText(),ProsedurSekunder1.getText(),KodeProsedurSekunder1.getText(),ProsedurSekunder2.getText(),KodeProsedurSekunder2.getText(),ProsedurSekunder3.getText(),KodeProsedurSekunder3.getText(),
                        ProsedurSekunder4.getText(),KodeProsedurSekunder4.getText(),ProsedurSekunder5.getText(),KodeProsedurSekunder5.getText(),KonsulDokter.getText(),Edukasi.getText(),Keadaan.getSelectedItem().toString(),
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            Valid.MyReportqry("rptDataResumePasienRanap.jasper","report","::[ Data Resume Pasien ]::",
                    ...
                    "resume_pasien_ranap.pemeriksaan_penunjang,resume_pasien_ranap.hasil_laborat,resume_pasien_ranap.obat_di_rs,"+
                    ...
                    "resume_pasien_ranap.kd_diagnosa_sekunder2,resume_pasien_ranap.diagnosa_sekunder3,resume_pasien_ranap.kd_diagnosa_sekunder3,resume_pasien_ranap.diagnosa_sekunder4,resume_pasien_ranap.kd_diagnosa_sekunder4,"+
                    "resume_pasien_ranap.prosedur_utama,resume_pasien_ranap.kd_prosedur_utama,resume_pasien_ranap.prosedur_sekunder,resume_pasien_ranap.kd_prosedur_sekunder,resume_pasien_ranap.prosedur_sekunder2,resume_pasien_ranap.kd_prosedur_sekunder2,"+
                    "resume_pasien_ranap.prosedur_sekunder3,resume_pasien_ranap.kd_prosedur_sekunder3,resume_pasien_ranap.prosedur_sekunder4,resume_pasien_ranap.kd_prosedur_sekunder4,resume_pasien_ranap.prosedur_sekunder5,"+
                    "resume_pasien_ranap.kd_prosedur_sekunder5,resume_pasien_ranap.edukasi,resume_pasien_ranap.cara_keluar,resume_pasien_ranap.ket_keluar,resume_pasien_ranap.keadaan,"+
                    "resume_pasien_ranap.ket_keadaan,resume_pasien_ranap.obat_pulang "+
    ...
    private void ProsedurUtamaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_ProsedurUtamaKeyPressed
        Valid.pindah(evt,KodeDiagnosaSekunder5,KodeProsedurUtama);
    ...
    private void PemeriksaanFisikKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_PemeriksaanFisikKeyPressed
        Valid.pindah2(evt,KeluhanUtama,PemeriksaanRad);
...
*/
    ...
    private void KonsulDokterKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KonsulDokterKeyPressed
        Valid.pindah(evt,KodeProsedurSekunder5,Edukasi);
    }//GEN-LAST:event_KonsulDokterKeyPressed
    ...
    private void KetKeluarKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KetKeluarKeyPressed
        Valid.pindah(evt,CaraKeluar,ObatPulang);
  ...
  private void BtnDiagnosaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnDiagnosaActionPerformed
    ...
    private void MnSendDokumentActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnSendDokumentActionPerformed
 if(tbObat.getSelectedRow() <= -1) {
        JOptionPane.showMessageDialog(null, "Silakan pilih data resume yang akan dikirim");
        return;
    }
    ...
    try {
        ...
        try (PreparedStatement ps = koneksi.prepareStatement(
                "select dpjp_ranap.kd_dokter,dokter.nm_dokter from dpjp_ranap inner join dokter on dpjp_ranap.kd_dokter=dokter.kd_dokter "+
        ...
        // Generate PDF file
        String outputFile = "temporary/" + Valid.SetTgl(DTPCari1.getSelectedItem()+"").replaceAll("-","") 
                          + "_" + tbObat.getValueAt(tbObat.getSelectedRow(),0).toString().replaceAll("/","") 
                          + "_resume.pdf";

        // Generate PDF menggunakan JasperReport
        JasperPrint jasperPrint = JasperFillManager.fillReport("report/rptLaporanResumeRanap.jasper", param, koneksi);
        ...
        if(jwtToken != null) {
            String email = Sequel.cariIsi(
                "SELECT pegawai.email FROM dokter INNER JOIN pegawai ON dokter.kd_dokter=pegawai.nik WHERE dokter.kd_dokter=?", 
                tbObat.getValueAt(tbObat.getSelectedRow(),3).toString()
            );
            
            if(email.isEmpty()) {
                JOptionPane.showMessageDialog(null, "Maaf Dokter/Pegawai Tersebut Belum Terdaftar Akun TTE Peruri");
                return;
            }
            
             String fileName = "Resume_" + tbObat.getValueAt(tbObat.getSelectedRow(),0).toString().replaceAll("/","_") + ".pdf";
            ...
            // Kirim dokumen dan dapatkan response
                ...
                if (response != null && "0".equals(response.get("resultCode"))) {
                    ...
                    try {
                        ...
                        // Gunakan queryu2tf untuk multiple parameters
                        sukses = Sequel.queryu2tf(
                            "INSERT INTO tracking_dokumen_ttd (no_rawat,nama_dokumen,tgl_kirim,order_id,status_ttd,keterangan,user_pengirim,email_ttd) VALUES (?,?,?,?,?,?,?,?)",
                            8,
                            params
                        );
                    ...
                    System.out.println("Error simpan tracking: " + e);
        ...
        // TODO add your handling code here:
    }//GEN-LAST:event_MnSendDokumentActionPerformed

    private void MnSendOTPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnSendOTPActionPerformed
       /*if(tbObat.getSelectedRow() <= -1) {
        JOptionPane.showMessageDialog(null, "Silakan pilih data resume yang akan ditandatangani");
        return;
    }

    try {
        // Ambil email dokter dari database
        String email = Sequel.cariIsi(
            "SELECT pegawai.email FROM dokter " +
        ...
        if(email.isEmpty()) {
            JOptionPane.showMessageDialog(null, "Email dokter belum diset di data pegawai");
            return;
        }
        ...
        if(rootNode.has("resultCode") && "0".equals(rootNode.get("resultCode").asText())) {
            ...
            if(dataNode != null && dataNode.has("tokenSession")) {
                String tokenSession = dataNode.get("tokenSession").asText();
                
                // Simpan token session baru
                boolean sukses = Sequel.queryu2tf(
                    "INSERT INTO tracking_tte_session (email, token_session, waktu_dibuat, status) " +
                    "VALUES (?,?,NOW(),'Aktif')",
                    2,
                    new String[]{email, tokenSession}
                );
                
                if(sukses) {
                    // Tampilkan dialog input OTP
                    String otpCode = JOptionPane.showInputDialog(null, 
                        "OTP telah dikirim ke email: " + email + "\n" +
                        "Silakan masukkan kode OTP:");
                    
                    if(otpCode != null && !otpCode.isEmpty()) {
                        // Validasi OTP
                        String validationResponse = apiPeruri.validateSession(email, tokenSession, otpCode);
                        ...
                        if(validationNode.has("resultCode") && "0".equals(validationNode.get("resultCode").asText())) {
                            JOptionPane.showMessageDialog(null, 
                                "Validasi OTP berhasil.\n" +
                                "Token session aktif selama 24 jam.");
                        } else {
                            ...
                            // Update status token menjadi expired jika validasi gagal
                            Sequel.queryu2(
                                "UPDATE tracking_tte_session SET status='Expired' " +
                                "WHERE email=? AND token_session=?",
                                2,
                                new String[]{email, tokenSession}
                            );
                        }
    ...
    try {
        ...
        if(rootNode.has("resultCode") && "0".equals(rootNode.get("resultCode").asText())) {
            ...
            if(dataNode != null && dataNode.has("tokenSession")) {
                ...
                if(sukses) {
                    boolean otpValid = false; // Flag untuk validasi OTP
                    while (!otpValid) {
                        // Tampilkan dialog input OTP
                        String otpCode = JOptionPane.showInputDialog(null, 
                            "OTP telah dikirim ke email: " + email + "\n" +
                        ...
                        if(otpCode != null && !otpCode.isEmpty()) {
                            ...
                            if(validationNode.has("resultCode") && "0".equals(validationNode.get("resultCode").asText())) {
                                JOptionPane.showMessageDialog(null, 
                                    "Validasi OTP berhasil.\n" +
                                    "Token session aktif selama 24 jam.");
                                otpValid = true; // Set flag menjadi true jika OTP valid
                            } else {
                                String resultDesc = validationNode.has("resultDesc") ? 
                                    validationNode.get("resultDesc").asText() : "Kode OTP tidak valid";
                                JOptionPane.showMessageDialog(null, "Validasi OTP gagal: " + resultDesc + "\nOTP Salah Silahkan Masukan Ulang OTP nya");
    ...
    }//GEN-LAST:event_MnSendOTPActionPerformed

    private void MnTTEDokumenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnTTEDokumenActionPerformed
        if (tbObat.getSelectedRow() <= -1) {
            JOptionPane.showMessageDialog(null, "Silakan pilih data resume yang akan ditandatangani");
            return;
        }
        ...
        try {
            ...
            String tokenSession = Sequel.cariIsi(
                    "SELECT token_session FROM tracking_tte_session "
                    + "WHERE email=? AND status='Aktif' AND "
                    + "waktu_dibuat >= DATE_SUB(NOW(), INTERVAL 24 HOUR)",
                    email
            );

            if (tokenSession.isEmpty()) {
                JOptionPane.showMessageDialog(null,
                        "Token session tidak ditemukan atau sudah expired.\n"
                        + "Silakan lakukan proses Send OTP terlebih dahulu.");
                return;
            }
            ...
            if (signingNode.has("resultCode") && "0".equals(signingNode.get("resultCode").asText())) {
                ...
                // Cek status dokumen
                String statusResponse = apiPeruri.checkDocumentStatus(orderId);
                JsonNode statusNode = mapper.readTree(statusResponse);

                if (statusNode.has("resultCode") && "0".equals(statusNode.get("resultCode").asText())) {
                    JsonNode dataNode = statusNode.get("data");
                    if (dataNode != null && dataNode.has("status")) {
                        String documentStatus = dataNode.get("status").asText();

                        // Log status dokumen
                        System.out.println("Status dokumen: " + documentStatus);

                        // Update status dokumen berdasarkan response
                        String newStatus = "Belum";
                        String keterangan = "Dokumen dalam proses tanda tangan";

                        if ("SIGNED".equalsIgnoreCase(documentStatus)) {
                            newStatus = "Selesai";
                            keterangan = "Dokumen telah ditandatangani";
                        } else if ("REJECTED".equalsIgnoreCase(documentStatus)) {
                            newStatus = "Gagal";
                            keterangan = "Dokumen ditolak untuk ditandatangani";
                        }

                        // Log hasil update sebelum melakukan query
                        System.out.println("Mencoba mengupdate status dokumen ke: " + newStatus);
                        boolean sukses = Sequel.queryu2tf(
                                "UPDATE tracking_dokumen_ttd SET "
                                + "status_ttd=?, "
                                + "keterangan=? "
                                + "WHERE order_id=?",
                                3,
                                new String[]{newStatus, keterangan, orderId}
                        );

                        // Log hasil update
                        System.out.println("Hasil update: " + sukses);
                        if (sukses) {
                            JOptionPane.showMessageDialog(null,
                                    "Status dokumen: " + documentStatus + "\n"
                                    + "Keterangan: " + keterangan);
                        } else {
                            JOptionPane.showMessageDialog(null, "Gagal mengupdate status dokumen");
                        }
                    }
                } else {
                    String resultDesc = statusNode.has("resultDesc")
                            ? statusNode.get("resultDesc").asText() : "Unknown error";
                    JOptionPane.showMessageDialog(null, "Gagal mengecek status dokumen: " + resultDesc);
                }
            } else {
                String resultDesc = signingNode.has("resultDesc")
                        ? signingNode.get("resultDesc").asText() : "Unknown error";
                JOptionPane.showMessageDialog(null, "Gagal melakukan tanda tangan: " + resultDesc);
            }
        ...
        // TODO add your handling code here:
    }//GEN-LAST:event_MnTTEDokumenActionPerformed

    private void MnDowloadDokumenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnDowloadDokumenActionPerformed
    if(tbObat.getSelectedRow() <= -1) {
        JOptionPane.showMessageDialog(null, "Silakan pilih data resume yang akan diunduh");
        return;
    }
    ...
    try {
        ...
        String orderId = Sequel.cariIsi(
            "SELECT order_id FROM tracking_dokumen_ttd " +
            "WHERE no_rawat=? AND status_ttd='Selesai' " +
            "ORDER BY tgl_kirim DESC LIMIT 1",
            tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()
        );

        if(orderId.isEmpty()) {
            JOptionPane.showMessageDialog(null, "Dokumen belum ditandatangani atau Order ID tidak ditemukan");
            return;
        }
        ...
        // Download dokumen
        String response = apiPeruri.downloadDocument(orderId);
        ObjectMapper mapper = new ObjectMapper();
        JsonNode rootNode = mapper.readTree(response);
        
        if(rootNode.has("resultCode") && "0".equals(rootNode.get("resultCode").asText())) {
            JsonNode dataNode = rootNode.get("data");
            if(dataNode != null && dataNode.has("base64Document")) {
                String base64Document = dataNode.get("base64Document").asText();
                
                // Buat direktori dokumen pengguna
                String userDocumentsPath = System.getProperty("user.home") + "/Documents/signed_documents";
                File dir = new File(userDocumentsPath);
                if (!dir.exists()) {
                ...
                String fileName = "Resume_" + 
                    tbObat.getValueAt(tbObat.getSelectedRow(),0).toString().replaceAll("/","_") + 
                    "_signed.pdf";
            ...
            String resultDesc = rootNode.has("resultDesc") ? 
                rootNode.get("resultDesc").asText() : "Unknown error";
            JOptionPane.showMessageDialog(null, "Gagal mengunduh dokumen: " + resultDesc);
        }
        ...
        // TODO add your handling code here:
    }//GEN-LAST:event_MnDowloadDokumenActionPerformed
/**/
    /**
    ...
    */
    ...
    private widget.TextBox KonsulDokter;
    private widget.Label LCount;
    private widget.TextBox Masuk;
    private javax.swing.JMenuItem MnDowloadDokumen;
    private javax.swing.JMenuItem MnInputDiagnosa;
    private javax.swing.JMenuItem MnLaporanResume;
    private javax.swing.JMenuItem MnSendDokument;
    private javax.swing.JMenuItem MnSendOTP;
    private javax.swing.JMenuItem MnTTEDokumen;
    ...
    public void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
                    ...
                    "resume_pasien_ranap.diagnosa_utama,resume_pasien_ranap.kd_diagnosa_utama,resume_pasien_ranap.diagnosa_sekunder,resume_pasien_ranap.kd_diagnosa_sekunder,resume_pasien_ranap.diagnosa_sekunder2,"+
                    "resume_pasien_ranap.kd_diagnosa_sekunder2,resume_pasien_ranap.diagnosa_sekunder3,resume_pasien_ranap.kd_diagnosa_sekunder3,resume_pasien_ranap.diagnosa_sekunder4,resume_pasien_ranap.kd_diagnosa_sekunder4,"+
                    "resume_pasien_ranap.diagnosa_sekunder5,resume_pasien_ranap.kd_diagnosa_sekunder5,resume_pasien_ranap.prosedur_utama,resume_pasien_ranap.kd_prosedur_utama,resume_pasien_ranap.prosedur_sekunder,resume_pasien_ranap.kd_prosedur_sekunder,"+
                    ...
                    "resume_pasien_ranap.kd_prosedur_sekunder4,resume_pasien_ranap.prosedur_sekunder5,resume_pasien_ranap.kd_prosedur_sekunder5,resume_pasien_ranap.konsul_dokter,resume_pasien_ranap.edukasi,resume_pasien_ranap.cara_keluar,"+
                    "resume_pasien_ranap.ket_keluar,resume_pasien_ranap.keadaan,resume_pasien_ranap.ket_keadaan,resume_pasien_ranap.obat_pulang,reg_periksa.kd_pj,penjab.png_jawab "+
                    "from resume_pasien_ranap inner join reg_periksa on resume_pasien_ranap.no_rawat=reg_periksa.no_rawat inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join dokter on resume_pasien_ranap.kd_dokter=dokter.kd_dokter inner join dokter as pengirim on reg_periksa.kd_dokter=pengirim.kd_dokter "+
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("kd_diagnosa_sekunder3"),rs.getString("diagnosa_sekunder4"),rs.getString("kd_diagnosa_sekunder4"),rs.getString("diagnosa_sekunder5"),rs.getString("kd_diagnosa_sekunder5"),rs.getString("prosedur_utama"),
                        ...
                        rs.getString("kd_prosedur_sekunder2"),rs.getString("prosedur_sekunder3"),rs.getString("kd_prosedur_sekunder3"),
                        rs.getString("prosedur_sekunder4"),rs.getString("kd_prosedur_sekunder4"),rs.getString("prosedur_sekunder5"),rs.getString("kd_prosedur_sekunder5"),rs.getString("konsul_dokter"),
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
         ...
         //   JalannyaPenyakit.setText(tbObat.getValueAt(tbObat.getSelectedRow(),17).toString());  
          ...
          //  TindakanSelamaDiRS.setText(tbObat.getValueAt(tbObat.getSelectedRow(),20).toString());  
            ...
            ProsedurSekunder4.setText(tbObat.getValueAt(tbObat.getSelectedRow(),40).toString());  
            KodeProsedurSekunder4.setText(tbObat.getValueAt(tbObat.getSelectedRow(),41).toString());  
            ProsedurSekunder5.setText(tbObat.getValueAt(tbObat.getSelectedRow(),42).toString());  
            KodeProsedurSekunder5.setText(tbObat.getValueAt(tbObat.getSelectedRow(),43).toString()); 
            KonsulDokter.setText(tbObat.getValueAt(tbObat.getSelectedRow(),44).toString());  
        ...
        //    LabBelum.setText(tbObat.getValueAt(tbObat.getSelectedRow(),42).toString());  
          ...
          //  KetDilanjutkan.setText(tbObat.getValueAt(tbObat.getSelectedRow(),49).toString());   
            ...
            CaraBayar.setText(tbObat.getValueAt(tbObat.getSelectedRow(),52).toString());  
    ...
    private void ganti() {
        if(Sequel.mengedittf("resume_pasien_ranap","no_rawat=? and kd_dokter=?","no_rawat=?,kd_dokter=?,diagnosa_awal=?,alasan=?,keluhan_utama=?,pemeriksaan_fisik=?,pemeriksaan_penunjang=?,"+
                ...
                "diagnosa_sekunder3=?,kd_diagnosa_sekunder3=?,diagnosa_sekunder4=?,kd_diagnosa_sekunder4=?,diagnosa_sekunder5=?,kd_diagnosa_sekunder5=?,prosedur_utama=?,kd_prosedur_utama=?,prosedur_sekunder=?,kd_prosedur_sekunder=?,"+
                "prosedur_sekunder2=?,kd_prosedur_sekunder2=?,prosedur_sekunder3=?,kd_prosedur_sekunder3=?,prosedur_sekunder4=?,kd_prosedur_sekunder4=?,prosedur_sekunder5=?,kd_prosedur_sekunder5=?,konsul_dokter=?,edukasi=?,cara_keluar=?,ket_keluar=?,keadaan=?,"+
                "ket_keadaan=?,obat_pulang=?",42,new String[]{
                TNoRw.getText(),KodeDokter.getText(),DiagnosaAwal.getText(),Alasan.getText(),KeluhanUtama.getText(),PemeriksaanFisik.getText(),
                PemeriksaanRad.getText(),HasilLaborat.getText(),ObatSelamaDiRS.getText(),DiagnosaUtama.getText(),KodeDiagnosaUtama.getText(),
                DiagnosaSekunder1.getText(),KodeDiagnosaSekunder1.getText(),DiagnosaSekunder2.getText(),KodeDiagnosaSekunder2.getText(),DiagnosaSekunder3.getText(),
                KodeDiagnosaSekunder3.getText(),DiagnosaSekunder4.getText(),KodeDiagnosaSekunder4.getText(),DiagnosaSekunder5.getText(),KodeDiagnosaSekunder5.getText(),ProsedurUtama.getText(),KodeProsedurUtama.getText(),
                ...
                KodeProsedurSekunder3.getText(),ProsedurSekunder4.getText(),KodeProsedurSekunder4.getText(),ProsedurSekunder5.getText(), 
                KodeProsedurSekunder5.getText(),KonsulDokter.getText(),Edukasi.getText(),CaraKeluar.getSelectedItem().toString(),KetKeluar.getText(),
                Keadaan.getSelectedItem().toString(),KetKeadaanPulang.getText(),
                ObatPulang.getText(),
              ...
              //     tbObat.setValueAt(TindakanSelamaDiRS.getText(),tbObat.getSelectedRow(),20);
                   ...
                   tbObat.setValueAt(DiagnosaSekunder5.getText(),tbObat.getSelectedRow(),30);
                   tbObat.setValueAt(KodeDiagnosaSekunder5.getText(),tbObat.getSelectedRow(),31);
                   ...
                   tbObat.setValueAt(ProsedurSekunder4.getText(),tbObat.getSelectedRow(),40);
                   tbObat.setValueAt(KodeProsedurSekunder4.getText(),tbObat.getSelectedRow(),41);
                   tbObat.setValueAt(ProsedurSekunder5.getText(),tbObat.getSelectedRow(),42);
                   tbObat.setValueAt(KodeProsedurSekunder5.getText(),tbObat.getSelectedRow(),43);
                   tbObat.setValueAt(KonsulDokter.getText(),tbObat.getSelectedRow(),44);
