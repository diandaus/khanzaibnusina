 ...
 * @author windiarto
 */
public final class RMRiwayatAwalMedisIGD extends javax.swing.JDialog {    
   ...
   // private final DefaultTableModel tabModeRegistrasi;
     ...
     * @param parent
     * @param modal */
    public RMRiwayatAwalMedisIGD(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMRiwayatAwalMedisIGD dialog = new RMRiwayatAwalMedisIGD(new javax.swing.JFrame(), true);
                            ...
                            htmlContent.append(
                                 ...
                                 "<tr>"+
                                    "<td valign='top'>"+
                                       ...
                                       "<table width='100%' border='0' align='center' cellpadding='3px' cellspacing='0px' class='tbl_form'>"+
                                          "<tr>"+
                                               "<td width='33%'>EKG : "+rs2.getString("ekg").replaceAll("(\r\n|\r|\n|\n\r)","<br>")+"</td>"+
                                               "<td width='33%'>Radiologi : "+rs2.getString("rad").replaceAll("(\r\n|\r|\n|\n\r)","<br>")+"</td>"+
                                               "<td width='33%'>Laborat : "+rs2.getString("lab").replaceAll("(\r\n|\r|\n|\n\r)","<br>")+"</td>"+
                                          "</tr>"+
                                       "</table>"+
                                    "</td>"+
                                 "</tr>"+
