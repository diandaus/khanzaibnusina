 ...
 * @author dosen
 */
public final class DlgBeriInstrumen2 extends javax.swing.JDialog {
    ...
    private String[] kode,nama,jmlawal,jmlakhir,keterangan;
     ...
     * @param parent
     * @param modal */
    public DlgBeriInstrumen2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        
        Object[] row={"P","Perhitungan Awal","Perhitungan Akhir","Kode Instrumen","Nama Instrumen","Keterangan"};
        tbModeInstrumen=new DefaultTableModel(null,row){
              @Override public boolean isCellEditable(int rowIndex, int colIndex){
                boolean a = false;
                if ((colIndex==0)||(colIndex==1)||(colIndex==2)||(colIndex==5)) {
                    a=true;
                }
                return a;
             }
    ...
    private void initComponents() {
        ...
        Tanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "04-02-2024 12:54:32" }));
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgBeriInstrumen2 dialog = new DlgBeriInstrumen2(new javax.swing.JFrame(), true);
        ...
        try{
            ...
            for(i=0;i<tbInstrumen.getRowCount();i++){
                if(tbInstrumen.getValueAt(i,0).toString().equals("true")){
                    ...
                    keterangan[index]=tbInstrumen.getValueAt(i,5).toString();
                    index++;
                }
            }
            ...
            for(i=0;i<jml;i++){
                tbModeInstrumen.addRow(new Object[] {pilih[i],jmlawal[i],jmlakhir[i],kode[i],nama[i],keterangan[i]});
            }       
        ...
        if (reply == JOptionPane.YES_OPTION) {
            ...
            try {                    
                ...
                if(Sequel.menyimpantf2("petugas_beri_instrumen_ok","?,?,?,?,?,?","No.Rawat",6,new String[]{
                    ...
                    for(i=0;i<tbInstrumen.getRowCount();i++){ 
                        if(tbInstrumen.getValueAt(i,0).toString().equals("true")){
                            Sequel.menyimpan2("beri_instrumen_ok","?,?,?,?,?","pemakaian instrumen",5,new String[]{
                                ...
                                tbInstrumen.getValueAt(i,5).toString()
                            });
